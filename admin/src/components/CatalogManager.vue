...
function open(kind: Editor, item?: Category | Service | Work) {
  ...
  if (kind === 'service') draft.value = { name: '', categoryId: categoryId.value || firstCategory?.id || '', coverUrl: '', price: 0, durationMinutes: 60, addonType: '', enabled: true, description: '' };
  if (kind === 'work') {
